...
contract FullWhaleFinal is ERC20PresetMinterPauser, Ownable {
    ...
    // uint256 public timeToWaitBeforeTransactionSentReset = 60; // test 60 seconds
    uint256 public maxTransferInPeriod = 10**3 * 10**6 * 10**18; // Pre sale max amount
    uint256 public choosenTotalSupply = 10**9 * 10**6 * 10**18;

    constructor() ERC20PresetMinterPauser('FullWhaleFinal', 'FWF') {
        mint(_msgSender(), choosenTotalSupply);
        //Create a uniswap pair for this new token

        _uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E); //pancakeSwap
